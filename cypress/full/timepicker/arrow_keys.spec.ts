...
describe('Timepicker demo page test suite: Arrow Keys', () => {
  ...
  it(`when user activates hours input and click keyboard arrow up key, then time number increases with
  appropriate changes in info alert`, () => {
    const newDate = new Date();
